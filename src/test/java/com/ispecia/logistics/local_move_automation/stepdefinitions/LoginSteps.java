...
public class LoginSteps {
	...
	public void launchApplication() {
		...
		DriverFactory.getDriver().get("https://local-moves-frontend-phi.vercel.app/");
	}
	...
	public void verifyLoginSuccess() {
		...
		Assert.assertTrue(loginPage.getToastMessage().contains("Login successful!"));
	}
	...
	public void verifyLogoutSuccess() {
		...
		Assert.assertTrue(loginPage.getToastMessage().contains("logged out successfully"));
	}
}