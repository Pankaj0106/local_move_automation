...
public class AdminStep {
	...
	public void user_validate_customer_quote_id_is_matching_with_the_admin_quote_id_for_and(String email, String password) {
	...
	public void the_customer_should_be_present_in_the_customer_grid_as(String email, String isPresent) {
		...
		boolean presentCheck = Boolean.parseBoolean(isPresent); 
		Assert.assertEquals(presentCheck, adminPage.isCustomerPresent(email));
	}
	...
	public void fill_details_for_step1(DataTable dataTable) {
		...
		adminPage.fillStep1ForCompanyRegisteration(companyName,companyEmail,companyPassword,firstName,lastName,phone,subscription);
	}
	...
	public void user_fill_details_foe_step2(DataTable dataTable) {
